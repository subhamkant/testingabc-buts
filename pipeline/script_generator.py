...
Create a YouTube video script (2–2.5 minutes, 8–10 scenes) about:
TOPIC: "{topic}"
LANGUAGE: {lang_label}
STYLE: {style_note}
...
{{
  ...
  "scenes": [
    {{
      "narration": "Spoken narration text in {lang_label} — 3-4 sentences written for a master storyteller's voice. Use vivid imagery, natural dramatic pauses (use '...' for pauses), and emotionally charged language. Each scene should take 12-18 seconds to speak aloud. Write as if narrating to a spellbound audience around a fire.",
...
- Narration: 3-4 emotionally gripping sentences per scene, 12-18 seconds when spoken aloud
- Generate exactly 8-10 scenes to fill 2-2.5 minutes total
