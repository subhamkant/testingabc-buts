...
_PROMPT = (
    ...
    "emerging from the chest or head), (6) EXPOSED NUDITY: any visible "
    "bare breast, nipple, or genitals, or fabric so sheer it clearly "
    "reveals them - this channel requires fully modest clothing, "
